...
public class Dashboard_Prepaid_BroadBand_Util_Stg extends PageNavigation {
...
private  Properties sourceStaticDataAccounts = new Properties();
	...
	protected  void setUp(){
		...
		(PageNavigation.prop.getProperty(AppConstants.COUNTRY_PREFIX),
						 PageNavigation.prop.getProperty(AppConstants.DASHBOARD_PREPAID_BROADBAND_STG),
						 PageNavigation.prop.getProperty(AppConstants.DASHBOARD_PREPAID_BROADBAND_STG_PASS));
	...
	/**
     ...
     private void readSourceDataFiles(){
    	String statusFileName = PageNavigation.prop.getProperty(AppConstants.CONFIG_FILES_LOCATION)
    											   .concat(AppConstants.DASHBOARD_PREPAID_BROADBAND_DATA_STATUS_STG);
    	...
    	String dataFileName = PageNavigation.prop.getProperty(AppConstants.CONFIG_FILES_LOCATION)
												 .concat(AppConstants.DASHBOARD_PREPAID_BROADBAND_STATIC_DATA_STG);
