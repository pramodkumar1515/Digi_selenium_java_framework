...
public class Dashboard_Postpaid_Util_Stg extends PageNavigation {

private  Logger log = Logger.getLogger(Dashboard_Postpaid_Util_Stg.class);
...
private  Properties sourceStaticDataAccounts = new Properties();
	...
	protected  void setUp(){
		...
		(PageNavigation.prop.getProperty(AppConstants.COUNTRY_PREFIX),
						 PageNavigation.prop.getProperty(AppConstants.DASHBOARD_POSTPAID_STG),
						 PageNavigation.prop.getProperty(AppConstants.DASHBOARD_POSTPAID_STG_PASS));
	...
	/**
     ...
     private void readSourceDataFiles(){
    	String statusFileName = PageNavigation.prop.getProperty(AppConstants.CONFIG_FILES_LOCATION)
    											   .concat(AppConstants.DASHBOARD_POSTPAID_DATA_STATUS_STG);
    	...
    	String dataFileName = PageNavigation.prop.getProperty(AppConstants.CONFIG_FILES_LOCATION)
												 .concat(AppConstants.DASHBOARD_POSTPAID_STATIC_DATA_STG);
