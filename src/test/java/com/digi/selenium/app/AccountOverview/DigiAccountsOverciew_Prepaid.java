...
import com.digi.selenium.util.AccountOverview.DigiAccountsOverview_Prepaid_Util;


public class DigiAccountsOverciew_Prepaid extends DigiAccountsOverview_Prepaid_Util {
	...
	@Test(priority=1)
	//Test Account No
	public void validateAccountNo() throws Exception{
	targetaccountno();
	...
	public void validateTotalAmtForPayment100() {
		...
		Assert.assertEquals(getTotalamt(), getSourceData(AppConstants.TOTALAMOUNTPAYMENT100));
	}
	@Test(priority=14)
	...
	public void validateTotalAmtForPayment10() {
		targetTotalAmtForPayment();
		Assert.assertEquals(getTotalamt(), getSourceData(AppConstants.TOTALAMOUNTPAYMENT10));
	}
	@Test(priority=24)
	...
	// To test reload of amount 30
		...
		public void validateTotalAmtForPayment30() {
			targetTotalAmtForPayment();
			Assert.assertEquals(getTotalamt(), getSourceData(AppConstants.TOTALAMOUNTPAYMENT30));
		}
		@Test(priority=34)
		...
		/*
		// To test reload of amount 100
		
			@Test(priority=39)
			public void validateReloadButton4() {
				reload1();
			}
			@Test(priority=40) 
			public void validateSelectPaymentRadio10() {
				clickOnRadioRM100();
			}
			@Test(priority=41)
			public void validateMsisdnForPayment10() {
			...
			@Test(priority=46)
			public void validateCancelAndReturn4() {
				clickCancel();
			}
			@Test(priority=47)
			...
			@Test(priority=48)
			public void validateReturnAccountsAndPaymentPage4() {
				backToAccountsAndPaymentsPage();
			}
			// end of test reload of amount 100
			
			// To test reload of RM 25 Broadband
			
			@Test(priority=49)
			public void validateReloadButton5() {
				reload1();
			}
			@Test(priority=50) 
			public void validateSelectPaymentRadio25() {
				clickOnRadioRM25Broadband();
			}
			@Test(priority=51)
			public void validateErrorMessageForBroadbandPayment() {
				targetErrorMessageForBroadbandPayment();
				Assert.assertEquals(getErrormsg(), "* Your purchase number is not eligible for this type of reload.");
			}
				
			@Test(priority=52)
			public void validateReturnAccountsAndPaymentPage5() {
				backToAccountsAndPaymentsPage();
			}
			// end of test reload of amount 100
		*/
