...
import com.digi.selenium.util.DashBoard.Dashboard_Postpaid_BroadBand_Util_Stg;



public class Dashboard_Postpaid_BroadBand_Stg extends Dashboard_Postpaid_BroadBand_Util_Stg{
	
	//logger 
	private  Logger log = Logger.getLogger(Dashboard_Postpaid_BroadBand_Stg.class);
 ...
 @Test(priority=1,enabled=false)
  public void verifyVoiceGraphData_Postpaid_BroadBand() throws InterruptedException {
	 try
		{
 ...
 public void verifyVoiceDonutValues_Postpaid_BroadBand() throws InterruptedException {
	 try
		{
 ...
 public void verifyInternetDonutValues_Postpaid_BroadBand() throws InterruptedException {
	 try
		{
 ...
 @Test(priority=2,enabled=false)
 public void verifyInternetGraphValues_Postpaid_BroadBand() throws InterruptedException {
	 try
		{
 ...
 @Test(priority=1,enabled=false)
 public void verifySMSGraphData_Postpaid_BroadBand() throws InterruptedException {
	 try
		{
 ...
 public void verifySMSDonutValues_Postpaid_BroadBand() throws InterruptedException {
	 try
		{
 ...
 @Test(priority=1,enabled=false)
 public void verifyTotalCostDonutValues_Postpaid_BroadBand() throws InterruptedException {
	 try
		{
		//getting the Target SMS Donut Values
 ...
 public void verifyTotalCostGraphData_Postpaid_BroadBand() throws InterruptedException {
	 try
		{
 ...
 @Test(priority=1,enabled=false)
 public void verifyOtherGraphData_Postpaid_BroadBand() throws InterruptedException {
	 try
		{
		//to read the the tooltip data under Internet tab
 ...
 public void verifyOtherDonutValues_Postpaid_BroadBand() throws InterruptedException {
	 try
		{
		//getting the Target SMS Donut Values
		 otherDonutValues();
