...
import com.digi.selenium.util.DashBoard.Dashboard_Postpaid_Util_Stg;



public class Dashboard_Postpaid_Stg extends Dashboard_Postpaid_Util_Stg{
	
	//logger 
	private  Logger log = Logger.getLogger(Dashboard_Postpaid_Stg.class);
 ...
 @Test(priority=1,enabled=false)
  public void verifyVoiceGraphData_Postpaid() throws InterruptedException {
	 try
		{
 ...
 @Test(priority=1,enabled=false)
 public void verifyVoiceDonutValues_Postpaid() throws InterruptedException {
	 try
		{
 ...
 @Test(priority=1,enabled=false)
 public void verifyInternetDonutValues_Postpaid() throws InterruptedException {
	 try
		{
 ...
 @Test(priority=1,enabled=false)
 public void verifyInternetGraphValues_Postpaid() throws InterruptedException {
	 try
		{
 ...
 @Test(priority=1,enabled=false)
 public void verifySMSGraphData_Postpaid() throws InterruptedException {
	 try
		{
 ...
 public void verifySMSDonutValues_Postpaid() throws InterruptedException {
	 try
		{
 ...
 public void verifyTotalCostDonutValues_Postpaid() throws InterruptedException {
	 try
		{
		//getting the Target SMS Donut Values
 ...
 @Test(priority=1,enabled=true)
 public void verifyTotalCostGraphData_Postpaid() throws InterruptedException {
	 try
		{
 ...
 @Test(priority=1,enabled=false)
 public void verifyOtherGraphData_Postpaid() throws InterruptedException {
	 try
		{
		//to read the the tooltip data under Internet tab
 ...
 @Test(priority=1,enabled=false)
 public void verifyOtherDonutValues_Postpaid() throws InterruptedException {
	 try
		{
		//getting the Target SMS Donut Values
		 otherDonutValues();
