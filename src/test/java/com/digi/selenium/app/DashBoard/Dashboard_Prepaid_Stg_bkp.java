...
import com.digi.selenium.util.DashBoard.Dashboard_Prepaid_Util_Stg;



public class Dashboard_Prepaid_Stg_bkp extends Dashboard_Prepaid_Util_Stg{
	
	//logger 
	private  Logger log = Logger.getLogger(Dashboard_Prepaid_Stg_bkp.class);
 ...
 @Test(priority=1,enabled=false)
  public void verifyVoiceGraphData_Prepaid() throws InterruptedException {
	 try
		{
 ...
 public void verifyVoiceDonutValues_Prepaid() throws InterruptedException {
	 try
		{
 ...
 public void verifyInternetDonutValues_Prepaid() throws InterruptedException {
	 try
		{
 ...
 @Test(priority=2,enabled=false)
 public void verifyInternetGraphValues_Prepaid() throws InterruptedException {
	 try
		{
 ...
 @Test(priority=1,enabled=false)
 public void verifySMSGraphData_Prepaid() throws InterruptedException {
	 try
		{
 ...
 public void verifySMSDonutValues_Prepaid() throws InterruptedException {
	 try
		{
 ...
 @Test(priority=1,enabled=false)
 public void verifyTotalCostDonutValues_Prepaid() throws InterruptedException {
	 try
		{
		//getting the Target SMS Donut Values
 ...
 public void verifyTotalCostGraphData_Prepaid() throws InterruptedException {
	 try
		{
 ...
 @Test(priority=1,enabled=false)
 public void verifyOtherGraphData_Prepaid() throws InterruptedException {
	 try
		{
		//to read the the tooltip data under Internet tab
 ...
 public void verifyOtherDonutValues_Prepaid() throws InterruptedException {
	 try
		{
		//getting the Target SMS Donut Values
		 otherDonutValues();
